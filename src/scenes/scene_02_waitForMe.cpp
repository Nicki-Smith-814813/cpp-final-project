...
void scene_02_waitForMe(Character& player) {
    ...
    dramaticPause(500);
    displaySpeakerDialogue("Hermes","Hermes:'Orpheus, I regret to inform you that Eurydice has passed away...'"); 
    displaySpeakerDialogue("Hermes","Hermes:'The snakebite was too much, or perhaps the cold was stronger than we realized.'");
    dramaticPause(500);
    displaySpeakerDialogue("Hermes","Hermes:'She's gone.'");
    ...
    displaySpeakerDialogue("Hermes", "Hermes:'If you wish to retrieve her, you must go there... You must descend into the Underworld.'");
    displaySpeakerDialogue("Hermes","Hermes:'Follow the road to the gates of Hadestown. There, you will find your answers.'");
    displaySpeakerDialogue("Hermes","Hermes:'But be warned, it is a journey filled with peril.'");
